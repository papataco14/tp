...
| **GUI**              | A Graphical User Interface (GUI) is a way to control software using graphics like icons and buttons instead of typing commands. It makes using software easier and more visual.                                       |
